...
const ParentComponents = () => {
    ...
    const handleForm = () => {
        switch(page){
            case 0: {
                return <Register formValues={values} onChange={onChange}></Register>;
            }
            case 1: {
                return <Second formValues={values}
                onChange={onChange}
                option={states}></Second>;
            }
            case 2: {
                return <Third  formValues={values} onChange={onChange}></Third>;
            }
            default: 
                return null;
        }
    ...
    <div className="grid gap-4 place-content-center items-center h-screen place-items-center ">
      ...
      <div className="flex-1">{handleForm()}</div>
